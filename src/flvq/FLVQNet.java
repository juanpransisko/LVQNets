...
/*	FLVQNetwork Class
	This is an implementation of Learning Vector Quantization with Fuzzy Theory

	** NOT YET OPTIMIZED **
	** For Thesis/Research utilization and purposes **
			
*/
public class FLVQNet {
	...
	public FLVQNet(double learn_rate, int iter) {
	...
	public FLVQNet(int n_neurons, int clusters) {
	...
	public FLVQNet(double learn_rate, int iter, int n_neurons, int n_clusters, int cat_type, int lim1, int lim2) {
		this.learning_rate = learn_rate;
		this.iterations = iter;
